...
<link rel="stylesheet" type="text/css" href="{{ st('admin') }}/lib/Hui-iconfont/1.0.8/iconfont.css" />
<link rel="stylesheet" type="text/css" href="{{ st('admin') }}/static/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="{{ st('admin') }}/static/h-ui.admin/css/style.css" />
<!--[if IE 6]>
...
<script type="text/javascript" src="{{ st('admin') }}/lib/jquery/1.9.1/jquery.min.js"></script> 
<script type="text/javascript" src="{{ st('admin') }}/static/h-ui/js/H-ui.min.js"></script> 
